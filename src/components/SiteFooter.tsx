    ...
    <footer className="mt-24 border-t border-border/60 bg-secondary text-secondary-foreground">
      <div className="container-page py-16 grid gap-12 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="flex items-center">
            <img src={logoUrl} alt="The Zeal Logo" className="h-14 w-auto object-contain" />
          </div>
          ...
          <div className="mt-6 flex gap-3">
            <a href="https://www.instagram.com/thezealapartments" target="_blank" rel="noreferrer" className="grid h-9 w-9 place-items-center rounded-full border border-secondary-foreground/20 hover:bg-secondary-foreground/10"><Instagram className="h-4 w-4" /></a>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-secondary-foreground/80">
            <li className="flex items-start gap-2"><Phone className="h-4 w-4 mt-0.5 text-accent" /> +234 816 799 6203</li>
            <li className="flex items-start gap-2"><Mail className="h-4 w-4 mt-0.5 text-accent" /> thezealluxuryapartments@gmail.com</li>
      ...
      <div className="border-t border-secondary-foreground/10">
        <div className="container-page py-6 text-xs text-secondary-foreground/60 flex flex-col md:flex-row justify-between gap-2">
          <span>© {new Date().getFullYear()} The Zeal Apartments. All rights reserved.</span>
