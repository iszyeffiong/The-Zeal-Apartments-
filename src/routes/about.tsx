...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About - The Zeal Apartments" },
      { name: "description", content: "The story, mission and vision behind The Zeal Apartments - boutique short-let apartments in Shelter Afrique Estate, Uyo, Akwa Ibom State." },
      { property: "og:title", content: "About - The Zeal Apartments" },
  ...
  return (
    <>
      <section className="container-page py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="mt-6 text-foreground/80 leading-relaxed">
            The Zeal Apartments began with a simple observation: short-term stays in Uyo too often felt like a compromise. We set out to build something different - a small, considered collection of apartments that feel like staying with friends who happen to have impeccable taste.
          </p>
        ...
        <img src={heroImg} alt="Inside a The Zeal apartment" loading="lazy" className="aspect-[4/5] w-full rounded-2xl object-cover" />
      </section>
      ...
      <section className="container-page py-20 grid md:grid-cols-[1fr_1.2fr] gap-12 items-center">
        <img src={exteriorImg} alt="The Zeal building exterior" loading="lazy" className="aspect-square w-full rounded-2xl object-cover" />
        <div>
