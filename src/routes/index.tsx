  ...
  return (
    <>
      ...
      <section className="relative isolate overflow-hidden">
        <img src={heroImg} alt="The Zeal Apartments" className="absolute inset-0 -z-10 h-full w-full object-cover" />
        ...
        <div className="container-page pt-28 pb-40 md:pt-40 md:pb-56 text-white">
          ...
          <h1 className="mt-6 max-w-3xl font-display text-5xl md:text-7xl leading-[1.05]">
            Welcome to <em className="text-accent not-italic">The Zeal Apartments!</em>
          </h1>
      ...
      <section className="bg-secondary text-secondary-foreground">
        <div className="container-page py-24 grid gap-12 md:grid-cols-2 items-center">
          <div>
            <p className="text-xs uppercase tracking-widest text-accent">Why The Zeal</p>
      ...
      <section className="container-page py-24">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {[
            ...
            { name: "Ifeoma E.", role: "Wedding guest · Port Harcourt", quote: "Walking distance from the venue and the most welcoming hosts. I'm booking The Zeal every time I'm in Uyo." },
          ].map((r) => (
      ...
      <section className="container-page py-24">
        <div className="flex items-end justify-between gap-6 mb-12">
          <div>
            <p className="text-xs uppercase tracking-widest text-primary">Inside The Zeal</p>
