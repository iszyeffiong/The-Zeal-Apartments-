...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-uP2hrNlD.mjs");
...
const manifest = {
  ...
  "818b594b783c10794e345ef74c1a58f06e8d7ff5470ada38a52b9db841b31b3c": {
    ...
    importer: () => import("./admin-CkY_mBkg.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D33M5I3w.mjs").then((n) => n.r),
    import("./start-BZKo9uH6.mjs"),
