...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BjIUeqyQ.mjs");
...
const manifest = {
  "08540e4be50dd862d2aa5b36439024cb87a93942829f037f45841c14312105ce": {
    functionName: "getUnavailableDates_createServerFn_handler",
    importer: () => import("./bookings.server-BGKKh3O0.mjs")
  },
  "330bebedfd2cc5c5a461c4dd4a2f60d1b3b11fca469d14362c726731fcf89f4c": {
    functionName: "fetchMyBookings_createServerFn_handler",
    importer: () => import("./dashboard-BpG9Qjhk.mjs")
  },
  "364cd851c0fe7661fbc3c0d9f8a8246230617e44f3f27dff49b84ac251eee45b": {
    functionName: "createPendingBooking_createServerFn_handler",
    importer: () => import("./bookings.server-BGKKh3O0.mjs")
  },
  "55ac03bdb5a0fb515dda10ad079d89c91b941e83ae5a94def2a9350ee7a0e5c3": {
    functionName: "getBookingById_createServerFn_handler",
    importer: () => import("./bookings.server-BGKKh3O0.mjs")
  },
  "6726896861087de2cb4ba7d6fac0e1424e243390cc8d81d1480ea4c32bb920a7": {
    functionName: "markBookingPaid_createServerFn_handler",
    importer: () => import("./bookings.server-BGKKh3O0.mjs")
  },
  "818b594b783c10794e345ef74c1a58f06e8d7ff5470ada38a52b9db841b31b3c": {
    functionName: "fetchAllBookings_createServerFn_handler",
    importer: () => import("./admin-B6ZOrJhE.mjs")
  },
  "ffe79cd258c29434dfc498661c6ae8d8babe8142e566d8bbbdd91c759545289d": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C76CnvDY.mjs").then((n) => n.r),
    import("./start-Dp6XLw5E.mjs"),
