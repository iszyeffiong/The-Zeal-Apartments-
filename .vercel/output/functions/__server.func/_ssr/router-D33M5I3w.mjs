...
import { c as createServerFn, T as TSS_SERVER_FUNCTION, g as getServerFnById } from "./server-BzYY8oOn.mjs";
...
const appCss = "/assets/styles-D7RKjh7k.css";
...
function SiteHeader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 border-b border-border/60 bg-background/85 backdrop-blur-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-page flex h-16 items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/logo.png", alt: "Rylme Logo", className: "h-12 w-auto object-contain" }) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-24 border-t border-border/60 bg-secondary text-secondary-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-page py-16 grid gap-12 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/logo.png", alt: "Rylme Logo", className: "h-14 w-auto object-contain" }) }),
...
const $$splitComponentImporter$a = () => import("./gallery-CvOznlAv.mjs");
...
const $$splitComponentImporter$9 = () => import("./dashboard-BT2H7jLs.mjs");
...
const $$splitComponentImporter$6 = () => import("./admin-CaQnNYfd.mjs");
...
const $$splitComponentImporter$5 = () => import("./about-XnTfzBH3.mjs");
...
const $$splitComponentImporter$4 = () => import("./index-njggDgwd.mjs");
...
const $$splitComponentImporter$3 = () => import("./apartments.index-DA-qlAmu.mjs");
...
const $$splitComponentImporter$2 = () => import("./checkout._id-C-R28CiQ.mjs");
...
const $$splitComponentImporter$1 = () => import("./book._id-RQmJPfiQ.mjs");
...
const $$splitComponentImporter = () => import("./apartments._id-C9mEhOxK.mjs");
