...
const Bath = createLucideIcon("bath", __iconNode$J);
const __iconNode$I = [
...
const CupSoda = createLucideIcon("cup-soda", __iconNode$y);
const __iconNode$x = [
...
const DoorClosed = createLucideIcon("door-closed", __iconNode$w);
const __iconNode$v = [
  [
    "path",
...
const PartyPopper = createLucideIcon("party-popper", __iconNode$i);
const __iconNode$h = [
  [
    "path",
    {
...
const Refrigerator = createLucideIcon("refrigerator", __iconNode$f);
const __iconNode$e = [
